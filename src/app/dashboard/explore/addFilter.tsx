...
export default function AddFilter({setIsOpen}: AddFilterProps) {
    return (
        <button onClick={() => setIsOpen(true)} className="w-[calc(50%-1rem)] min-w-[400px] relative bg-white/60 min-h-[350px] h-fit text-black text-3xl hover:underline hover:bg-white cursor-pointer ">
            Add Filter
        </button>
