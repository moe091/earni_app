...
export default function Dashboard() {
    return (
        <div className="h-screen w-screen text-center flex justify-center relative">
            <div className="grid grid-cols-2 gap-4 pt-10 bg-white/40">
                <div className="font-mono mx-9 h-[500px] w-[540px] flex justify-center flex-col items-center">
                    <Link 
                        ...
                        >
                        <span className="text-black w-full bg-white/40 text-5xl p-4">New Visualization</span>
                    </Link>
                </div>
                <div className="font-mono mx-9 h-[500px] w-[540px] flex justify-center flex-col items-center">
                    <Link 
                        ...
                        >
                        <span className="text-black w-full bg-white/40 text-5xl p-4">Explore Data</span>
                    </Link>
                </div>
                <div className="font-mono mx-9 h-[500px] w-[540px] flex justify-center flex-col items-center">
                    <Link 
                        ...
                        >
                        <span className="text-black w-full bg-white/40 text-5xl p-4">New Strategy</span>
                    </Link>
                </div>
            </div>
        </div>
